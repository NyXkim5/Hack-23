function submit(){
    ...
    fetch("https://0795-128-195-95-38.ngrok-free.app/" + location + "&imageUrl=" + imageurl, {headers: new Headers({"ngrok-skip-browser-warning": "sdfsdf"})}).then(res =>res.json()).then(renderResults);
}
